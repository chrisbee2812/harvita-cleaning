...
const cleaningNavLinks = [
  { href: "/services/cleaning", label: "Home" },
  { href: "/services/cleaning/reviews", label: "Reviews" },
  // { href: "/contact", label: "Contact" },
];


const cleaningServicesNavLinks = [
  { href: "/services/cleaning/services/domestic", label: "Domestic Cleaning" },
  { href: "/services/cleaning/services/office", label: "Office Cleaning" },
  { href: "/services/cleaning/services/commercial", label: "Commercial Cleaning" },
];
      ...
      <div className="container flex h-28 max-w-screen-2xl items-center">
        ...
        <div className="hidden ml-8 md:block flex-col gap-8">
          ...
          <nav className="hidden gap-4 text-lg mt-4 md:flex">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start">
                 <DropdownMenuItem asChild>
                  <Link href="/services/cleaning/services/">All Services</Link>
                </DropdownMenuItem>
            ...
            <Button key="cleaningContact" variant="ghost" className={cn(
                  "gap-1 px-2 text-xl transition-colors hover:text-foreground/80",
                  pathname.startsWith(`/services/cleaning/contact`) ? "text-foreground font-semibold" : "text-foreground/60"
                )}>
                <Link
                  href="/services/cleaning/contact"
                  className={cn(
                    "transition-colors hover:text-foreground/80",
                    pathname === "/services/cleaning/contact" ? "text-foreground font-semibold" : "text-foreground/60"
                  )}
                >
                  Contact
                </Link>
        ...
        <div className="flex flex-col flex-1 items-end justify-end gap-4 space-x-2">
          ...
          <Button asChild className="hidden md:inline-flex rounded-full">
            <Link href="/services/cleaning/contact">Request a Consultation</Link>
          </Button>
      ...
      <div className="container flex h-28 max-w-screen-2xl items-center">
        ...
        <div className="hidden ml-8 md:block flex-col gap-8">
          ...
          <nav className="hidden gap-4 text-lg mt-4 md:flex">
            ...
            <Button key="cleaningContact" variant="ghost" className={cn(
                  "gap-1 px-2 text-xl transition-colors hover:text-foreground/80",
                  pathname.startsWith(`/contact`) ? "text-foreground font-semibold" : "text-foreground/60"
                )}>
                <Link
                  href="/contact"
                  className={cn(
